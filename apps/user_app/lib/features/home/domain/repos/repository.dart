...
abstract class CoursesRepository {
  ...
  Future<Either<String, bool>> saveCoursedetails(SaveCourseParams params);
  Future<Either<String, CourseProgressModel>> getProgress(GetCourseProgressParams params);
  Future<Either<String, List<CoursePreview>>> getMentorCourses(List<String> params);
